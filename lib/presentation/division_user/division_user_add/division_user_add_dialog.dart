part of 'division_user_add_worker.dart';

class DivisionUserAddDialog extends StatelessWidget {
  final DivisionUserAddArgument argument;
  const DivisionUserAddDialog({
    super.key,
  ...
  Widget build(BuildContext context) {
    return BackdropFilter(
      ...
      child: Dialog(
        ...
        child: GetBuilder<DivisionUserAddBloc>(
          init: DivisionUserAddBloc(
          ...
          return SwitcherBuilder(builder: () {
            if ([create, dropdown].any((e) => e is LoadingCase)) {
              ...
              return Column(
                ...
                children: [
                  const BaseDialogAppbar(title: "Add User Division"),
                  Padding(
...
class _Body extends StatelessWidget {
  final DivisionUserAddBloc bloc;
