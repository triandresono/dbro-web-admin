...
class SharedSwitch extends StatefulWidget {
  ...
  @override
  _SharedSwitchState createState() => _SharedSwitchState();
}

class _SharedSwitchState extends State<SharedSwitch>
  ...
  @override
  void didUpdateWidget(SharedSwitch oldWidget) {
