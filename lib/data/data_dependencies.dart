...
import 'package:dbro_admin/data/repository/clockin/clockin_repository_impl.dart';
...
import 'package:dbro_admin/data/repository/payroll/payroll_repository_impl.dart';
...
class DataDependencies {
  DataDependencies() {
    ...
    Get.lazy(PayrollDatasource(Get.find()));
    Get.lazy(ClockinDatasource(Get.find()));
    ...
    Get.lazy<PayrollRepository>(PayrollRepositoryImpl(Get.find()));
    Get.lazy<ClockinRepository>(ClockinRepositoryImpl(Get.find()));
  }
}
